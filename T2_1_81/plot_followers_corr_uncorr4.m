load('followers_corr_uncorr4.mat')
if ~isfolder('figures_followers_corr_uncorr4')
        mkdir('figures_followers_corr_uncorr4');
end
...
savefig(gcf, 'figures_followers_corr_uncorr4/num_fol.fig')
...
savefig(gcf, 'figures_followers_corr_uncorr4/prob_fol.fig')
...
savefig(gcf, 'figures_followers_corr_uncorr4/delay_fol.fig')
