%remove repetitive followers

load('followers_corr_uncorr2_2.mat')
if ~isfolder('figures_followers_corr_uncorr2_2')
        mkdir('figures_followers_corr_uncorr2_2');
end
...
savefig(gcf, 'figures_followers_corr_uncorr2_2/num_fol.fig')
...
savefig(gcf, 'figures_followers_corr_uncorr2_2/prob_fol.fig')
...
savefig(gcf, 'figures_followers_corr_uncorr2_2/delay_fol.fig')
