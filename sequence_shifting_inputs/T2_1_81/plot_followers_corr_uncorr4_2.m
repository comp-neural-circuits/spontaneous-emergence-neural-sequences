load('followers_corr_uncorr4_2.mat')
if ~isfolder('figures_followers_corr_uncorr4_2')
        mkdir('figures_followers_corr_uncorr4_2');
end

figure
scatter(cell2mat(followers_corr_diag), cell2mat(followers_uncorr), 'filled')
hold on
scatter(cell2mat(followers_corr_subdiag)+cell2mat(followers_corr_subdiag2), cell2mat(followers_uncorr), 'filled')
ax = gca;
a = get(ax,'Label');
...
savefig(gcf, 'figures_followers_corr_uncorr4_2/num_fol.fig')
...
subplot(3,1,2)
histogram([cell2mat(all_prob_corr_subdiag); cell2mat(all_prob_corr_subdiag2)], ...
        'Normalization', 'pdf', 'BinWidth', 0.05, 'FaceColor', [0.7 0 0], 'LineStyle', 'none')
ylabel('Probability density')
ax = gca;
a = get(ax,'Label');
set(gca,'Label', a,'fontsize',12)
...
p_value_prob_subdiag = ranksum([cell2mat(all_prob_corr_subdiag); cell2mat(all_prob_corr_subdiag2)], cell2mat(all_prob_uncorr), 'tail', 'right');
subplot(3, 1, 2)
...
savefig(gcf, 'figures_followers_corr_uncorr4_2/prob_fol.fig')
...
legend('the same block')
subplot(3,1,2)
histogram([cell2mat(all_delay_corr_subdiag); cell2mat(all_delay_corr_subdiag2)]*1e3, ...
        'Normalization', 'pdf', 'BinWidth', 5, 'FaceColor', [0.7 0 0], 'LineStyle', 'none')
ylabel('Probability density')
ax = gca;
a = get(ax,'Label');
set(gca,'Label', a,'fontsize',12)
...
p_value_delay_subdiag = ranksum([cell2mat(all_delay_corr_subdiag); cell2mat(all_delay_corr_subdiag2)], cell2mat(all_delay_uncorr), 'tail', 'left');
subplot(3, 1, 2)
...
savefig(gcf, 'figures_followers_corr_uncorr4_2/delay_fol.fig')
