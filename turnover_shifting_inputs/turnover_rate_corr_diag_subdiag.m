                        ...
                        for corr_seg = 1:round(EE_seg.m/corr_range)
                                if corr_seg < round(EE_seg.m/corr_range)
                                        index_ee_strong{i} = [index_ee_strong{i};
                                                find(effw_EE > thresh_EE & EE_seg.rowval >= (corr_seg-1)*corr_range + 1 & ...
...
save('strong_weights_turnover/turnover_corr_diag_subdiag_rate.mat', 'ratio_n0_n1', 'n0_ee', 'n1_ee', 'n0_ie', 'n1_ie', 'resolution')
