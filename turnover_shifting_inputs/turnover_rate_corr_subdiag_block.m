                        ...
                        for corr_seg = 1:seg_num
                                if corr_seg < seg_num
                                        index_ee_strong{i, corr_seg} = find(effw_EE > thresh_EE & EE_seg.rowval >= ...
                                                corr_seg*corr_range + 1 & EE_seg.rowval <= (corr_seg+1)*corr_range & EE_colval >= ...
                                                (corr_seg - 1)*corr_range + 1 & EE_colval <= corr_seg*corr_range)
                                else
                                        index_ee_strong{i, corr_seg} = find(effw_EE > thresh_EE & ...
...
save('strong_weights_turnover/turnover_corr_subdiag_block_rate.mat', 'n0_ee', 'n1_ee', 'resolution')
