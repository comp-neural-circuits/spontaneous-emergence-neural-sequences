...
fit_decay_ee = fit(repmat(resolution, [1, trials])', remain_rate_ee(:), 'b*exp(-x/a)+1-b', 'Start', [1000, 0.5]);
plot_x = 1:max(resolution);
plot(plot_x, fit_decay_ee.b*exp(-plot_x/fit_decay_ee.a)+1-fit_decay_ee.b, 'color', [117, 76, 36]/255, 'LineWidth', 1);
xlabel('Interval (s)')
ylabel('Ratio of remaining strong connections')
ax = gca;
a = get(ax,'Label');
set(gca,'Label', a,'fontsize',15)
text(1200, 0.6, ['\tau_{ee} = ', num2str(round(fit_decay_ee.a)), 's'], 'FontSize', 15, 'color', [117, 76, 36]/255)
ylim([0 1])
...
fit_decay_ee = fit(repmat(resolution, [1, trials])', remain_rate_ee(:), 'b*exp(-x/a)+1-b', 'Start', [1000, 0.5]);
plot_x = 1:max(resolution);
plot(plot_x, fit_decay_ee.b*exp(-plot_x/fit_decay_ee.a)+1-fit_decay_ee.b, 'color', [46, 49, 146]/255, 'LineWidth', 1);
xlabel('Interval (s)')
ylabel('Ratio of remaining strong connections')
ax = gca;
a = get(ax,'Label');
set(gca,'Label', a,'fontsize',15)
text(1200, 0.7, ['\tau_{ee} = ', num2str(round(fit_decay_ee.a)), 's'], 'FontSize', 15, 'color', [46, 49, 146]/255)
ylim([0 1])
...
fit_decay_ee = fit(repmat(resolution, [1, trials])', remain_rate_ee(:), 'b*exp(-x/a)+1-b', 'Start', [1000, 0.5]);
plot_x = 1:max(resolution);
plot(plot_x, fit_decay_ee.b*exp(-plot_x/fit_decay_ee.a)+1-fit_decay_ee.b, 'color', 'k', 'LineWidth', 1);
xlabel('Interval (s)')
ylabel('Ratio of remaining strong connections')
ax = gca;
a = get(ax,'Label');
set(gca,'Label', a,'fontsize',15)
text(1200, 0.8, ['\tau_{ee} = ', num2str(round(fit_decay_ee.a)), 's'], 'FontSize', 15, 'color', 'k')
ylim([0 1])
...
fit_decay_ee = fit(repmat(resolution, [1, trials])', remain_rate_ee(:), 'b*exp(-x/a)+1-b', 'Start', [1000, 0.5]);
plot_x = 1:max(resolution);
plot(plot_x, fit_decay_ee.b*exp(-plot_x/fit_decay_ee.a)+1-fit_decay_ee.b, 'color', [0.5, 0.5, 0.5], 'LineWidth', 1);
xlabel('Interval (s)')
ylabel('Ratio of remaining strong connections')
ax = gca;
a = get(ax,'Label');
set(gca,'Label', a,'fontsize',15)
text(1200, 0.25, ['\tau_{ee} = ', num2str(round(fit_decay_ee.a)), 's'], 'FontSize', 15, 'color', [0.5, 0.5, 0.5])
ylim([0 1])
...
for i = 1:length(resolution)
        remain_rate_ee(i, :) =  sum(cell2mat(n0_ee_avg(:, i)'), 1) ./ ...
                sum(cell2mat(n0_ee_avg(:, i)') + cell2mat(n1_ee_avg(:, i)'), 1);
        scatter(resolution(i)*ones(trials, 1), remain_rate_ee(i, :), 'filled', 'MarkerFaceColor', [237, 30, 121]/255)
end

fit_decay_ee = fit(repmat(resolution, [1, trials])', remain_rate_ee(:), 'b*exp(-x/a)+1-b', 'Start', [1000, 0.5]);
plot_x = 1:max(resolution);
plot(plot_x, fit_decay_ee.b*exp(-plot_x/fit_decay_ee.a)+1-fit_decay_ee.b, 'color', [237, 30, 121]/255, 'LineWidth', 1);
xlabel('Interval (s)')
ylabel('Ratio of remaining strong connections')
ax = gca;
a = get(ax,'Label');
...
savefig(gcf, 'strong_weights_turnover/turnover_all_corr_uncorr_2.fig')
