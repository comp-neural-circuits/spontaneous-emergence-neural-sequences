...
ckpt = 80
network_path = string("../1/", rcd_name, "/")
...
E.param.rt = rt_e
E.param.ηIP = ηIP_e
E.param.input_t = input_t_e
E.param.gap_t = gap_t_e
E.param.ξext = ξext_e
E.param.τext_high = τext_e_high
E.param.τext_low = τext_e_low
...
I.M = 0
I.param.ξext = ξext_i
I.param.τext_high = τext_i_high
I.param.τext_low = τext_i_low
